...
export default function CreateNewStaffMember() {
  ...
  const [criminalRecordImage, setCriminalRecordImage] = useState<File | null>(
    null
  );
            ...
            >
              ...
              <div className="col-span-2 flex flex-col gap-2 w-full">
                ...
                <Input
                  ...
                  required
                  onChange={(e) =>
                    setNationalIdImage(e.target.files && e.target.files[0])
                  }
                  disabled={uploading}
                  className="w-full rounded-xl bg-light_border dark:bg-dark_border border-none ring-0 outline-none"
              ...
              <div className="col-span-2 flex flex-col gap-2 w-full">
                ...
                <Input
                  ...
                  required
                  onChange={(e) =>
                    setCriminalRecordImage(e.target.files && e.target.files[0])
                  }
                  disabled={uploading}
                  className="w-full rounded-xl bg-light_border dark:bg-dark_border border-none ring-0 outline-none"
