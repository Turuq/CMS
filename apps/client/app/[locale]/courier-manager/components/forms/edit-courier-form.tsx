...
import { EditCourier, EditCourierSchema } from '@/utils/validation/courier';
...
import { updateCourier } from '@/app/actions/courier-actions';

export default function EditCourierForm({
  locale,
  defaultValues,
}: {
  locale: string;
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      setLoading(true);
      updateCourier({ id: defaultValues._id, courier: value })
        .then(() => {
          ...
          <div className="flex flex-col gap-1 items-center justify-center w-full">
            ...
            >
              <form.Field
                name="name"
                validators={{
                  onChange: EditCourierSchema.shape.name,
                }}
              >
                {(field) => (
              ...
              <form.Field
                name="username"
                validators={{
                  onChange: EditCourierSchema.shape.username,
                }}
              >
                {(field) => (
                  <div className="flex flex-col gap-2 w-full">
              ...
              <form.Field
                name="email"
                validators={{
                  onChange: EditCourierSchema.shape.email,
                }}
              >
                {(field) => (
              ...
              <form.Field
                name="phone"
                validators={{
                  onChange: EditCourierSchema.shape.phone,
                }}
              >
                {(field) => (
                  <div className="col-span-2 lg:col-span-1 flex flex-col gap-2 w-full">
              ...
              <form.Field
                name="nationalId"
                validators={{
                  onChange: EditCourierSchema.shape.nationalId,
                }}
              >
                {(field) => (
                  <div className="col-span-2 lg:col-span-1 flex flex-col gap-2 w-full">
              ...
              <form.Field
                name="zone"
                validators={{
                  onChange: EditCourierSchema.shape.zone,
                }}
              >
                {(field) => (
                  <div className="col-span-2 lg:col-span-1 flex flex-col gap-2 w-full">
              ...
              <div className="col-span-2 grid grid-cols-1 items-center gap-5">
                ...
                <div className="grid grid-cols-3 items-center gap-5">
                  ...
                  <div
                    className={`col-span-3 lg:col-span-1 flex items-center justify-center bg-light_border dark:bg-muted rounded-xl w-full h-full min-h-32 p-2 ${defaultValues.criminalRecordImage !== form.getFieldValue('driverLicenseImage') && 'ring-1 ring-amber-500 dark:ring-amber-300'}`}
                  >
                    {form.getFieldValue('driverLicenseImage') ? (
                      <Image
                        src={form.getFieldValue('driverLicenseImage')}
                        alt="Driver License"
                        width={160}
                        height={160}
                        className="rounded-xl object-cover"
