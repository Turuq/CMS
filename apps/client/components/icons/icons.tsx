// Icons are provided by HugeIcons https://hugeicons.com/icons?style=Stroke&type=Rounded
// Copy the JSX version of the svg and create a new field for it in the object below
...
export const icons = {
  home: (
    <svg
      ...
      height={16}
      fill={'none'}
      className="text-inherit group-hover:scale-110"
    >
      <path
        d="M10 18L14 18"
        stroke="currentColor"
  ...
  hanger: (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="lucide lucide-coat-hanger"
    >
  ...
  resetFilter: (
    ...
    >
      ...
      />
      <path
        d="M15.0132 6L14.5139 8.08437L15.3434 7.56607C15.9343 7.11729 16.6687 6.85119 17.4646 6.85119C19.4172 6.85119 21 8.45151 21 10.4256C21 12.3997 19.4172 14 17.4646 14C15.7543 14 14.3276 12.772 14 11.1405"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  cashPayment: (
    ...
    >
      <path
        d="M21 21C20.7284 21.2035 20.4288 21.3807 20.1062 21.5273C19.0659 22 17.6917 22 14.9432 22H9.05683C6.30834 22 4.9341 22 3.89382 21.5273C3.57124 21.3807 3.27158 21.2035 3 21"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M2 10C2 6.46252 2 4.69377 3.0528 3.5129C3.22119 3.32403 3.40678 3.14935 3.60746 2.99087C4.86213 2 6.74142 2 10.5 2H13.5C17.2586 2 19.1379 2 20.3925 2.99087C20.5932 3.14935 20.7788 3.32403 20.9472 3.5129C22 4.69377 22 6.46252 22 10C22 13.5375 22 15.3062 20.9472 16.4871C20.7788 16.676 20.5932 16.8506 20.3925 17.0091C19.1379 18 17.2586 18 13.5 18H10.5C6.74142 18 4.86213 18 3.60746 17.0091C3.40678 16.8506 3.22119 16.676 3.0528 16.4871C2 15.3062 2 13.5375 2 10Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M14.551 10C14.551 11.3807 13.4317 12.5 12.051 12.5C10.6703 12.5 9.55099 11.3807 9.55099 10C9.55099 8.61929 10.6703 7.5 12.051 7.5C13.4317 7.5 14.551 8.61929 14.551 10Z"
        stroke="currentColor"
        strokeWidth="2"
      />
    </svg>
  ...
  processing: (
    <svg
      ...
      width={16}
      height={16}
      className="text-yellow-500 dark:text-amber-300"
      fill={'none'}
    >
      <path
  ...
  forwardCall: (
    ...
    >
      ...
      />
      <path
        d="M19.7731 4.22687L13 11M19.7731 4.22687C19.2678 3.72156 16.8846 4.21665 16.1649 4.22687M19.7731 4.22687C20.2784 4.73219 19.7834 7.11544 19.7731 7.83508"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  localeSwitcher: (
    <svg
      ...
      width={16}
      height={16}
      className="text-inherit group-hover:text-accent"
      fill={'none'}
    >
